...
def create_index(idx_name, prefix):
    try:
        ...
        # create Index
        r.ft(idx_name).create_index(fields=schema, definition=definition)


create_index("xyz","lmn")

r.json().set(f"lmn:SPIAC00001733564", Path.root_path(), snt1)
