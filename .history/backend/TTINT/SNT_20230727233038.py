...
def declare_item(req):
    ...
    declare_item(req=req, product=product, barcode=barcode,lpcode=lpcode,cbcode=cbcode)
...
def declare_item(
    ...
    obj_content = {
        ...
        "receiverInfo": {
            ...
            "email": req['addressee_details']['email'],
            "telephone":req['addressee_details']['id_ref'],
        },
        "senderInfo": {
